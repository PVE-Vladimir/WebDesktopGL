    ...
    function openDoc(href) {
        top.location.href = `${scriptDir.replace('/js/directories', '/')}viewer.html?doc=${encodeURIComponent(href)}`;
        //top.location.href = "../viewer.html?doc=" + encodeURIComponent(href);
        return false;
    }
    ...
    function searchText() {
      ...
      const iframes = content.querySelectorAll('iframe');
      // Раскомментировать если на сайте появится iframe
      // iframes[0].focus();
